...
local modeCap = capabilities["concertmirror08464.deermaHumMjjsqMode"]
local targetHumidityCap = capabilities["concertmirror08464.deermaHumMjjsqTargetHumidity"]
local indicatorLightCap = capabilities["concertmirror08464.deermaHumMjjsqIndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.deermaHumMjjsqBuzzer"]
local waterShortageCap = capabilities["concertmirror08464.deermaHumMjjsqWaterShortage"]
local tankAttachedCap = capabilities["concertmirror08464.deermaHumMjjsqTankAttached"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "deerma-humidifier-mjjsq"

-- miIO model: deerma.humidifier.mjjsq
...
local driver = Driver("miio-deerma-humidifier-mjjsq", {
