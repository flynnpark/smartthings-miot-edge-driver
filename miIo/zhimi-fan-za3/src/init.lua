...
local fanModeCap = capabilities["concertmirror08464.zhimiFanZa3FanMode"]
local ledBrightnessCap = capabilities["concertmirror08464.zhimiFanZa3LedBrightness"]
local buzzerCap = capabilities["concertmirror08464.zhimiFanZa3Buzzer"]
local childLockCap = capabilities["concertmirror08464.zhimiFanZa3ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.zhimiFanZa3HorizontalAngleV2"]
local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "zhimi-fan-za3"
local CURRENT_FAN_MODE = "current_fan_mode"
local CURRENT_PERCENT = "current_percent"

-- miIO model: zhimi.fan.za3
...
local driver = Driver("miio-zhimi-fan-za3", {
