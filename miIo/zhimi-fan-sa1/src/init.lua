...
local fanModeCap = capabilities["concertmirror08464.zhimiFanSa1FanMode"]
local ledBrightnessCap = capabilities["concertmirror08464.zhimiFanSa1LedBrightness"]
local buzzerCap = capabilities["concertmirror08464.zhimiFanSa1Buzzer"]
local childLockCap = capabilities["concertmirror08464.zhimiFanSa1ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.zhimiFanSa1HorizontalAngleV2"]
local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "zhimi-fan-sa1"
