...
local modeCap = capabilities["concertmirror08464.airdogAirX3Mode"]
local fanLevelCap = capabilities["concertmirror08464.airdogAirX3FanLevel"]
local childLockCap = capabilities["concertmirror08464.airdogAirX3ChildLock"]
local cleanFilterCap = capabilities["concertmirror08464.airdogAirX3CleanFilter"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "airdog-air-purifier-x3"
local CURRENT_MODE = "current_mode"
local CURRENT_FAN_LEVEL = "current_fan_level"

-- miIO model: airdog.airpurifier.x3
...
-- Mode auto and sleep always send speed 1. Manual speed range for x3 is 1..4.
...
local driver = Driver("miio-airdog-airpurifier-x3", {
