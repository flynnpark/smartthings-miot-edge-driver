...
local humidifierCoreTargetHumidity = capabilities["concertmirror08464.zhimiHumCa1TargetHumidity"]
local humidifierCoreFanMode = capabilities["concertmirror08464.zhimiHumCa1FanMode"]
local humidifierWaterDryMode = capabilities["concertmirror08464.zhimiHumCa1DryMode"]
local humidifierWaterWaterLevel = capabilities["concertmirror08464.zhimiHumCa1WaterLevel"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiHumCa1Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiHumCa1ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiHumCa1LedBrightness"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60

-- miIO model: zhimi.humidifier.ca1
-- Core read properties: power, mode, humidity, buzzer, led_b, child_lock, limit_hum, temp_dec, depth, dry
