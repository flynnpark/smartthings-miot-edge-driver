...
Installation channel (`wonjj_miot`): https://bestow-regional.api.smartthings.com/invite/r3MyzkOpOz2p
...
|--------|----------|--------|--------------|-------------|
| `miot/zhimi-air-purifier-mb5` | MIoT | `zhimi.airpurifier.mb5` | Xiaomi Smart Air Purifier 4 | `Zhimi Air Purifier MB5` |
| `miot/zhimi-air-purifier-airp-mb5` | MIoT | `zhimi.airp.mb5` | Xiaomi Smart Air Purifier 4 | `Xiaomi Smart Air Purifier 4` |
| `miot/xiaomi-air-purifier-mb5` | MIoT | `xiaomi.airp.mb5` | Mijia Smart Air Purifier 6 | `Mijia Smart Air Purifier 6` |
| `miot/xiaomi-air-purifier-mb6` | MIoT | `xiaomi.airp.mb6` | Mijia Smart Air Purifier MAX | `Mijia Smart Air Purifier MAX` |
| `miot/xiaomi-air-purifier-va5` | MIoT | `xiaomi.airp.va5` | Mijia Smart Air Purifier 5 Pro | `Mijia Smart Air Purifier 5 Pro` |
| `miot/zhimi-air-purifier-mb5a` | MIoT | `zhimi.airp.mb5a` | Xiaomi Smart Air Purifier 4 | `Zhimi Air Purifier MB5A` |
| `miot/zhimi-air-purifier-va2` | MIoT | `zhimi.airp.va2` | Xiaomi Air Purifier Pro H | `Zhimi Air Purifier VA2` |
| `miot/zhimi-air-purifier-vb4` | MIoT | `zhimi.airp.vb4` | Xiaomi Air Purifier Pro 4 | `Zhimi Air Purifier VB4` |
| `miot/zhimi-air-purifier-rmb1` | MIoT | `zhimi.airp.rmb1` | Xiaomi Smart Air Purifier 4 Lite | `Zhimi Air Purifier RMB1` |
| `miot/zhimi-air-purifier-rma1` | MIoT | `zhimi.airpurifier.rma1` | Xiaomi Smart Air Purifier 4 Lite | `Zhimi Air Purifier RMA1` |
| `miot/zhimi-air-purifier-rma2` | MIoT | `zhimi.airpurifier.rma2` | Xiaomi Smart Air Purifier 4 Lite | `Zhimi Air Purifier RMA2` |
| `miot/zhimi-air-purifier-za1` | MIoT | `zhimi.airpurifier.za1` | Smartmi Air Purifier | `Zhimi Air Purifier ZA1` |
| `miot/zhimi-air-purifier-meb1` | MIoT | `zhimi.airp.meb1` | Xiaomi Smart Air Purifier Elite | `Xiaomi Smart Air Purifier Elite` |
| `miot/zhimi-air-purifier-cpa4` | MIoT | `zhimi.airp.cpa4` | Xiaomi Smart Air Purifier 4 Compact | `Xiaomi Smart Air Purifier 4 Compact` |
| `miot/zhimi-air-purifier-mb4` | MIoT | `zhimi.airpurifier.mb4` | Xiaomi Mi Air Purifier 3C | `Zhimi Air Purifier MB4` |
| `miot/zhimi-air-purifier-mb4a` | MIoT | `zhimi.airp.mb4a` | Xiaomi Mi Air Purifier 3C v2 | `Zhimi Air Purifier MB4A` |
| `miot/zhimi-air-purifier-ma4` | MIoT | `zhimi.airpurifier.ma4` | Xiaomi Mi Air Purifier 3 | `Zhimi Air Purifier MA4` |
| `miot/zhimi-air-purifier-mb3` | MIoT | `zhimi.airpurifier.mb3` | Xiaomi Mi Air Purifier 3H | `Zhimi Air Purifier MB3` |
| `miot/zhimi-air-purifier-mb3a` | MIoT | `zhimi.airpurifier.mb3a` | Xiaomi Mi Air Purifier 3H v2 | `Zhimi Air Purifier MB3A` |
...
| `miot/deerma-humidifier-jsq2w` | MIoT | `deerma.humidifier.jsq2w` | Xiaomi Smart Humidifier 2 | `Deerma Humidifier JSQ2W` |
| `miot/xiaomi-humidifier-airmx` | MIoT | `xiaomi.humidifier.airmx` | Mijia Mist-Free Humidifier 3 Pro | `Mijia Mist-Free Humidifier 3 Pro` |
| `miot/xiaomi-humidifier-p800` | MIoT | `xiaomi.humidifier.p800` | Mijia Mist-Free Humidifier 3 (800) | `Xiaomi Humidifier P800` |
| `miot/xiaomi-humidifier-p1200` | MIoT | `xiaomi.humidifier.p1200` | Mijia No-Fog Humidifier 3 1200 | `Xiaomi Humidifier P1200` |
...
| `miot/dmaker-fan-p15` | MIoT | `dmaker.fan.p15` | Mi Smart Standing Fan Pro | `Mi Smart Standing Fan Pro` |
| `miot/dmaker-fan-p9` | MIoT | `dmaker.fan.p9` | Mi Smart Tower Fan | `Mi Smart Tower Fan` |
...
| `miot/pinlo-fan-fs1` | MIoT | `pinlo.fan.fs1` | Plabson Slim Fan | `Plabson Slim Fan` |
...
| `miIo/zhimi-air-purifier-v2` | miIO | `zhimi.airpurifier.v2` | Xiaomi Mi Air Purifier | `Zhimi Air Purifier V2` |
| `miIo/zhimi-air-purifier-v3` | miIO | `zhimi.airpurifier.v3` | Xiaomi Mi Air Purifier | `Zhimi Air Purifier V3` |
| `miIo/zhimi-air-purifier-v5` | miIO | `zhimi.airpurifier.v5` | Xiaomi Mi Air Purifier Pro | `Zhimi Air Purifier V5` |
| `miIo/zhimi-air-purifier-v6` | miIO | `zhimi.airpurifier.v6` | Xiaomi Mi Air Purifier Pro V6 | `Zhimi Air Purifier V6` |
| `miIo/zhimi-air-purifier-v7` | miIO | `zhimi.airpurifier.v7` | Xiaomi Mi Air Purifier Pro V7 | `Zhimi Air Purifier V7` |
| `miIo/zhimi-air-purifier-m1` | miIO | `zhimi.airpurifier.m1` | Xiaomi Mi Air Purifier 2 Mini | `Zhimi Air Purifier M1` |
| `miIo/zhimi-air-purifier-m2` | miIO | `zhimi.airpurifier.m2` | Xiaomi Air Purifier 2 | `Zhimi Air Purifier M2` |
| `miIo/zhimi-air-purifier-ma1` | miIO | `zhimi.airpurifier.ma1` | Xiaomi Air Purifier 2S | `Zhimi Air Purifier MA1` |
...
| `miIo/philips-sread1` | miIO | `philips.light.sread1` | Philips Smart Desk Lamp | `Philips Smart Desk Lamp` |
| `miIo/philips-sread2` | miIO | `philips.light.sread2` | Philips Smart Desk Lamp 2 | `Philips Smart Desk Lamp 2` |
| `miIo/yeelink-light-lamp1` | miIO | `yeelink.light.lamp1` | Xiaomi Mi Desk Lamp | `Xiaomi Mi Desk Lamp` |
| `miIo/yeelink-light-mono1` | miIO | `yeelink.light.mono1` | Yeelight Mono Bulb | `Yeelight Mono Bulb` |
