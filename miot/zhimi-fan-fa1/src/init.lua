...
local fanLevelCap = capabilities["concertmirror08464.zhimiFanFa1FanLevel"]
local fanModeCap = capabilities["concertmirror08464.zhimiFanFa1FanMode"]
local hAngleCap = capabilities["concertmirror08464.zhimiFanFa1HorizontalAngleV2"]
local vAngleCap = capabilities["concertmirror08464.zhimiFanFa1VerticalAngleV2"]
local indicatorCap = capabilities["concertmirror08464.zhimiFanFa1Indicator"]
local buzzerCap = capabilities["concertmirror08464.zhimiFanFa1Buzzer"]
local childLockCap = capabilities["concertmirror08464.zhimiFanFa1ChildLock"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "zhimi-fan-fa1"

-- MIoT model: zhimi.fan.fa1
-- specModel: zhimi-fa1
...
local driver = Driver("miot-zhimi-fan-fa1", {
