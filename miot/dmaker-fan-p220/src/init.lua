-- Mijia Smart DC Inverter Circulating Standing Fan Driver
...
local fanModeCap = capabilities["concertmirror08464.dmakerFanP220FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.dmakerFanP220IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.dmakerFanP220Buzzer"]
local childLockCap = capabilities["concertmirror08464.dmakerFanP220ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.dmakerFanP220HorizontalAngleV2"]
local verticalAngleCap = capabilities["concertmirror08464.dmakerFanP220VerticalAngleV2"]
...
--   piid=4..7 automatic on/off temperature settings, not exposed
--   piid=8 swing-all shortcut, W, not exposed
...
local driver = Driver("miot-dmaker-fan-p220", {
