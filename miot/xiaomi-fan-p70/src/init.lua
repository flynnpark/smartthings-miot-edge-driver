-- Xiaomi BPLDS10DM Smart Desktop Air Circulation Fan Driver
...
local fanModeCap = capabilities["concertmirror08464.xiaomiFanP70FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.xiaomiFanP70IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.xiaomiFanP70Buzzer"]
local childLockCap = capabilities["concertmirror08464.xiaomiFanP70ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.xiaomiFanP70HorizontalAngleV2"]
local verticalAngleCap = capabilities["concertmirror08464.xiaomiFanP70VerticalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "xiaomi-fan-p70"

-- MIoT model: xiaomi.fan.p70
-- Source: exact MIoT spec xiaomi-p70 v1, Xiaomi BPLDS10DM manual, and hass-xiaomi-miot MIoT LAN support.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local driver = Driver("miot-xiaomi-fan-p70", {
