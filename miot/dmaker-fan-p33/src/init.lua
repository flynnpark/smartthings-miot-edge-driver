-- Xiaomi Smart Standing Fan 2 Pro Driver
...
local fanModeCap = capabilities["concertmirror08464.dmakerFanP33FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.dmakerFanP33IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.dmakerFanP33Buzzer"]
local childLockCap = capabilities["concertmirror08464.dmakerFanP33ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.dmakerFanP33HorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "dmaker-fan-p33"

-- MIoT model: dmaker.fan.p33
-- Source: python-miio FanMiot exact model, MIoT spec dmaker-p33 v1, user model report.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local driver = Driver("miot-dmaker-fan-p33", {
