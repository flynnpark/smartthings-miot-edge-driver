-- Zhimi Air Purifier RMB1 Driver
...
local purifierModeAirPurifierMode = capabilities["concertmirror08464.zhimiAirRmb1AirPurifierMode"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirRmb1Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirRmb1ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirRmb1LedBrightness"]

local PROFILE_NAME = "zhimi-rmb1"
local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60

-- MIoT spec: urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-rmb1:2
        ...
        if result.code == 0 then
            ...
            elseif result.siid == ENVIRONMENT_SIID then
                ...
                elseif result.piid == TEMPERATURE_PIID then
                    local temperature = {value = result.value, unit = "C"}
...
local driver = Driver("miot-air-purifier-rmb1", {
