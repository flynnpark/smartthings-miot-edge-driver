...
-- Precomputed MD5 constants avoid runtime calculation.
local md5_K = {
...
-- Return the 16-byte binary digest required by the protocol module.
...
-- Return the 32-character hexadecimal digest.
