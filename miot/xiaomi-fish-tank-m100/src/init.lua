...
local controls = capabilities["concertmirror08464.xiaomiFishTankM100Controls"]
local light = capabilities["concertmirror08464.xiaomiFishTankM100Light"]
...
local function device_added(_, device)
    ...
    device:emit_event(controls.pumpStatus({value = "closed"}))
    ...
    device:emit_event(controls.indicatorBrightness({value = "middle"}))
