...
-- MIoT model: dmaker.derh.22l
-- specModel: dmaker-22l
-- URN: urn:miot-spec-v2:device:dehumidifier:0000A02D:dmaker-22l:1
-- Source: homebridge-miot exact dmaker.derh.22l local MIoT module
--         with requiresMiCloud=false, plus exact MIoT spec.
--
...
-- dm-service (siid=7)
--   piid=1 off-delay-time, uint16 minutes, RW, not exposed
--   piid=2 dry-after-off, bool, RW
--   piid=3 dry-left-time, uint16, R, seconds, diagnostic, not exposed
--   piid=4 is-warming-up, bool, R, diagnostic, not exposed
...
local driver = Driver("miot-dmaker-dehumidifier-22l", {
