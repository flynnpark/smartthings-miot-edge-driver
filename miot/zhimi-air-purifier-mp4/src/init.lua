...
local airPurifierModeCap = capabilities["concertmirror08464.zhimiAirMp4Mode"]
local fanLevelCap = capabilities["concertmirror08464.zhimiAirMp4FanLevel"]
local anionCap = capabilities["concertmirror08464.zhimiAirMp4Anion"]
local buzzerCap = capabilities["concertmirror08464.zhimiAirMp4Buzzer"]
local childLockCap = capabilities["concertmirror08464.zhimiAirMp4ChildLock"]
local displayLevelCap = capabilities["concertmirror08464.zhimiAirMp4DisplayLevel"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "zhimi-air-purifier-mp4"

-- MIoT model: zhimi.airp.mp4
-- specModel: zhimi-mp4
...
--   piid=4 mode, uint8, RW; 0=Auto, 1=Sleep, 2=Favorite, 3=Manual -> zhimiAirMp4Mode.airPurifierMode
--   piid=5 fan-level, uint8, RW; 1=Level1, 2=Level2, 3=Level3 -> zhimiAirMp4FanLevel.fanLevel
--   piid=6 anion, bool, RW -> zhimiAirMp4Anion.anion
...
--   piid=1 alarm, bool, RW -> zhimiAirMp4Buzzer.buzzer
-- Physical Control Locked service (siid=8)
--   piid=1 physical-controls-locked, bool, RW -> zhimiAirMp4ChildLock.childLock
...
--   piid=2 brightness, uint8, RW; 0=Close, 1=Bright, 2=Brightest -> zhimiAirMp4DisplayLevel.displayLevel
...
local function ensure_profile(device)
    if not device:supports_capability_by_id("concertmirror08464.zhimiAirMp4Mode", "main") then
...
local driver = Driver("miot-zhimi-air-purifier-mp4", {
