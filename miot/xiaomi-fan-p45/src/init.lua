-- Xiaomi Smart Tower Fan 2 Driver
...
local fanModeCap = capabilities["concertmirror08464.xiaomiFanP45FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.xiaomiFanP45IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.xiaomiFanP45Buzzer"]
local childLockCap = capabilities["concertmirror08464.xiaomiFanP45ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.xiaomiFanP45HorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "xiaomi-fan-p45"

-- MIoT model: xiaomi.fan.p45
-- Source: homebridge-miot supported device list, Xiaomi Korea product page, MIoT spec xiaomi-p45 v1.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local DELAY_REMAIN_TIME_PIID = 3  -- R countdown minutes, not exposed

-- Xiaomi dm-service (siid=13), natural wind customization and movement writes are not exposed.
local DM_SERVICE_SIID = 13
local START_LEFT_PIID = 1
local START_RIGHT_PIID = 2
...
local driver = Driver("miot-xiaomi-fan-p45", {
