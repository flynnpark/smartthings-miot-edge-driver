...
local fanModeFanMode = capabilities["concertmirror08464.zhimiAirVb4FanMode"]
local fanSpeedFanSpeed = capabilities["concertmirror08464.zhimiAirVb4FanSpeed"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirVb4Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirVb4ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirVb4LedBrightness"]
...
local function ensure_profile(device)
    if not device:supports_capability_by_id(fanModeFanMode.ID, "main") then
        device:try_update_metadata({profile = "zhimi-vb4"})
    end
end
...
local driver = Driver("miot-air-purifier-vb4", {
