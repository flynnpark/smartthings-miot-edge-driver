...
local fanModeFanMode = capabilities["concertmirror08464.zhimiAirMa4FanMode"]
local fanSpeedFanSpeed = capabilities["concertmirror08464.zhimiAirMa4FanSpeed"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirMa4Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirMa4ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirMa4LedBrightness"]
...
-- MIoT spec: urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-ma4:3
...
local driver = Driver("miot-air-purifier-ma4", {
