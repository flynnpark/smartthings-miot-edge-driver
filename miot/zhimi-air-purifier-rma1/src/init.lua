-- Zhimi Air Purifier RMA1 Driver
...
local purifierModeAirPurifierMode = capabilities["concertmirror08464.zhimiAirRma1AirPurifierMode"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirRma1Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirRma1ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirRma1LedBrightness"]

local PROFILE_NAME = "zhimi-rma1"
local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60

-- MIoT spec: urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-rma1:1
...
local driver = Driver("miot-air-purifier-rma1", {
