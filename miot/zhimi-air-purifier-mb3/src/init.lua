...
local fanModeFanMode = capabilities["concertmirror08464.zhimiAirMb3FanMode"]
local fanSpeedFanSpeed = capabilities["concertmirror08464.zhimiAirMb3FanSpeed"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirMb3Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirMb3ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirMb3LedBrightness"]
...
-- MIoT spec: urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-mb3:3
...
local function ensure_profile(device)
    if not device:supports_capability_by_id(fanModeFanMode.ID, "main") then
        device:try_update_metadata({profile = "zhimi-mb3"})
    end
end
...
local driver = Driver("miot-air-purifier-mb3", {
