...
-- Exact local MIoT model: Zhimi Air Purifier RMA3
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> zhimiAirRma3Mode.airPurifierMode
--   siid=3 piid=1 -> humidity
--   siid=3 piid=7 -> temperature
--   siid=3 piid=4 -> pm25
--   siid=4 piid=1 -> filter
--   siid=6 piid=1 -> zhimiAirRma3Buzzer.buzzer
--   siid=7 piid=2 -> zhimiAirRma3DisplayLevel.displayLevel
--   siid=8 piid=1 -> zhimiAirRma3ChildLock.childLock
--   siid=11 piid=1 -> zhimiAirRma3FanLevel.fanLevel
