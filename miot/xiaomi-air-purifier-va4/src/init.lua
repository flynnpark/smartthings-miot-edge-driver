...
-- Exact local MIoT model: Xiaomi Air Purifier VA4
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> xiaomiAirVa4Mode.airPurifierMode
--   siid=2 piid=5 -> xiaomiAirVa4FanLevel.fanLevel
--   siid=2 piid=6 -> xiaomiAirVa4Anion.anion
--   siid=2 piid=7 -> xiaomiAirVa4Uv.uv
--   siid=3 piid=1 -> humidity
--   siid=3 piid=7 -> temperature
--   siid=3 piid=4 -> pm25
--   siid=3 piid=11 -> formaldehyde
--   siid=4 piid=1 -> filter
--   siid=6 piid=1 -> xiaomiAirVa4Buzzer.buzzer
--   siid=7 piid=2 -> xiaomiAirVa4DisplayLevel.displayLevel
--   siid=8 piid=1 -> xiaomiAirVa4ChildLock.childLock
--   siid=9 piid=1 -> xiaomiAirVa4FavoriteFanLevel.favoriteFanLevel
...
local function set_favoriteFanLevel_handler(_, device, command)
    ...
    local ok = pcall(miot.set, device, ip, token, 9, 1, math.floor(value))
    if ok then
