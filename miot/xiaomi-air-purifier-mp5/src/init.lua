...
-- Exact local MIoT model: Xiaomi Air Purifier MP5
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> xiaomiAirMp5Mode.airPurifierMode
--   siid=2 piid=5 -> xiaomiAirMp5FanLevel.fanLevel
--   siid=2 piid=6 -> xiaomiAirMp5Anion.anion
--   siid=2 piid=7 -> xiaomiAirMp5Uv.uv
--   siid=3 piid=1 -> humidity
--   siid=3 piid=7 -> temperature
--   siid=3 piid=4 -> pm25
--   siid=3 piid=5 -> pm10
--   siid=4 piid=1 -> filter
--   siid=6 piid=1 -> xiaomiAirMp5Buzzer.buzzer
--   siid=7 piid=1 -> xiaomiAirMp5Display.display
--   siid=7 piid=2 -> xiaomiAirMp5DisplayLevel.displayLevel
--   siid=8 piid=1 -> xiaomiAirMp5ChildLock.childLock
