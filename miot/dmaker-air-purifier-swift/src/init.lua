...
-- Exact local MIoT model: dmaker.airp.swift
...
air_purifier_miot.run({
    driver_name = "miot-dmaker-air-purifier-swift",
    profile_name = "dmaker-air-purifier-swift",
    expected_capability = "concertmirror08464.dmakerAirSwiftMode",
    discovery = discovery,
    properties = {
        {
            kind = "power",
        ...
        },
        {
            ...
            siid = 2,
            piid = 4,
            capability = "concertmirror08464.dmakerAirSwiftMode",
        ...
        },
        {
            ...
            siid = 2,
            piid = 7,
            capability = "concertmirror08464.dmakerAirSwiftFanLevel",
            attribute = "fanLevel",
            command = "setFanLevel",
            argument = "fanLevel",
            to_st = {
        ...
        },
        {
            ...
            siid = 10,
            piid = 1,
            capability = "concertmirror08464.dmakerAirSwiftFanOn",
            attribute = "fanOn",
            command = "setFanOn",
            argument = "fanOn",
            to_st = {
        ...
        },
        {
            ...
            siid = 10,
            piid = 2,
            capability = "concertmirror08464.dmakerAirSwiftFanSpeed",
            attribute = "fanSpeed",
            command = "setFanSpeed",
            argument = "fanSpeed",
            initial = 1
        },
        {
            ...
            siid = 10,
            piid = 3,
            capability = "concertmirror08464.dmakerAirSwiftSwing",
        ...
        },
        {
            ...
            siid = 10,
            piid = 5,
            capability = "concertmirror08464.dmakerAirSwiftSwingAngle",
        ...
        },
        {
            ...
            siid = 2,
            piid = 8,
            capability = "concertmirror08464.dmakerAirSwiftAnion",
            attribute = "anion",
            command = "setAnion",
            argument = "anion",
            to_st = {
        ...
        },
        {
            ...
            siid = 7,
            piid = 2,
            capability = "concertmirror08464.dmakerAirSwiftScreen",
        ...
        },
        {
            ...
            siid = 6,
            piid = 1,
            capability = "concertmirror08464.dmakerAirSwiftBuzzer",
            attribute = "buzzer",
            command = "setBuzzer",
            argument = "buzzer",
            to_st = {
        ...
        },
        {
            ...
            siid = 6,
            piid = 2,
            capability = "concertmirror08464.dmakerAirSwiftVolume",
        ...
        },
        {
            ...
            siid = 8,
            piid = 1,
            capability = "concertmirror08464.dmakerAirSwiftChildLock",
            attribute = "childLock",
