...
local fanModeCap = capabilities["concertmirror08464.dmakerFanP9FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.dmakerFanP9IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.dmakerFanP9Buzzer"]
local childLockCap = capabilities["concertmirror08464.dmakerFanP9ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.dmakerFanP9HorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "dmaker-fan-p9"

-- MIoT model: dmaker.fan.p9
-- Source: python-miio FanMiot mapping, openHAB model docs, MIoT spec dmaker-p9 v2.
-- Fan service (siid=2)
local FAN_SIID = 2
...
local driver = Driver("miot-dmaker-fan-p9", {
