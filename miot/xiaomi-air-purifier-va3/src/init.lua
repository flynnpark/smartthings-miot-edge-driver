...
-- Exact local MIoT model: Xiaomi Air Purifier VA3
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> xiaomiAirVa3Mode.airPurifierMode
--   siid=2 piid=5 -> xiaomiAirVa3FanLevel.fanLevel
--   siid=2 piid=6 -> xiaomiAirVa3Anion.anion
--   siid=2 piid=7 -> xiaomiAirVa3Uv.uv
...
--   siid=6 piid=1 -> xiaomiAirVa3Buzzer.buzzer
--   siid=7 piid=1 -> xiaomiAirVa3Display.display
--   siid=7 piid=2 -> xiaomiAirVa3DisplayLevel.displayLevel
--   siid=8 piid=1 -> xiaomiAirVa3ChildLock.childLock
