-- Xiaomi Smart Standing Air Circulation Fan Driver
...
local fanModeCap = capabilities["concertmirror08464.xiaomiFanP76FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.xiaomiFanP76IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.xiaomiFanP76Buzzer"]
local childLockCap = capabilities["concertmirror08464.xiaomiFanP76ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.xiaomiFanP76HorizontalAngleV2"]
local verticalAngleCap = capabilities["concertmirror08464.xiaomiFanP76VerticalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "xiaomi-fan-p76"

-- MIoT model: xiaomi.fan.p76
-- Source: exact FanP76(MiotDevice) local implementation in syssi/xiaomi_fan commit b994a09,
-- plus MIoT spec xiaomi-p76 v1 as the equivalent capability contract.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local driver = Driver("miot-xiaomi-fan-p76", {
