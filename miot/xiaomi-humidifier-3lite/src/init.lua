-- Xiaomi Humidifier 3lite Driver
...
local controlsScreenBrightness = capabilities["concertmirror08464.xiaomiHum3liteScreenLevel"]
local controlsOverwetProtect = capabilities["concertmirror08464.xiaomiHum3liteOverwetProtect"]
local statsFault = capabilities["concertmirror08464.xiaomiHum3liteFault"]
local statsWaterStatus = capabilities["concertmirror08464.xiaomiHum3liteWaterStatus"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60

-- MIoT model: xiaomi.humidifier.3lite
...
--   piid=2 fault, uint8, R: 0=noFaults, 1=motorFault, 2=pumpFault, 3=pumpFail, 4=pause, 5=lowWater
--   piid=3 mode, uint8, RW: 0=constantHumidity, 1=sleep, 2=strong
--   piid=5 target-humidity, uint8, RW, 40..70 %, step 1
--   piid=11 automatic-air-drying, bool, RW
--   piid=12 air-dry-remain-time, uint16, R, seconds, diagnostic, not exposed
--   piid=13 overwet-protect, bool, RW
...
local AUTOMATIC_AIR_DRYING_PIID = 11
local OVERWET_PROTECT_PIID = 13
...
local driver = Driver("miot-xiaomi-humidifier-3lite", {
