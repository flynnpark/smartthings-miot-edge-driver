...
local fanModeFanMode = capabilities["concertmirror08464.zhimiAirVa2FanMode"]
local fanSpeedFanSpeed = capabilities["concertmirror08464.zhimiAirVa2FanSpeed"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirVa2Buzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirVa2ChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirVa2LedBrightness"]
...
local function ensure_profile(device)
    if not device:supports_capability_by_id(fanModeFanMode.ID, "main") then
        device:try_update_metadata({profile = "zhimi-va2"})
    end
end
...
local driver = Driver("miot-air-purifier-va2", {
