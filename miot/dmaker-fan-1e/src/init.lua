-- Mijia DC Inverter Standing Fan E Driver
...
local fanModeCap = capabilities["concertmirror08464.dmakerFan1eFanMode"]
local indicatorLightCap = capabilities["concertmirror08464.dmakerFan1eIndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.dmakerFan1eBuzzer"]
local childLockCap = capabilities["concertmirror08464.dmakerFan1eChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.dmakerFan1eHorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "dmaker-fan-1e"

-- MIoT model: dmaker.fan.1e
-- Source: exact MIoT spec urn:miot-spec-v2:device:fan:0000A005:dmaker-1e:1.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local driver = Driver("miot-dmaker-fan-1e", {
