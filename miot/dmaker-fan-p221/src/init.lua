-- Mijia Smart DC Circulating Standing Fan Battery Edition Driver
...
local PROFILE_NAME = "dmaker-fan-p221"

-- MIoT model: dmaker.fan.p221
...
local driver = Driver("miot-dmaker-fan-p221", {
