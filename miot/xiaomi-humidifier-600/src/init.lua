...
-- MIoT model: xiaomi.humidifier.600
...
local function ensure_profile(device)
    if not device:supports_capability_by_id(controls.ID, "main") then
        device:try_update_metadata({profile = "xiaomi-humidifier-600"})
    end
end
...
local driver = Driver("miot-xiaomi-humidifier-600", {
