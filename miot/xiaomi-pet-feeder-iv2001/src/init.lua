-- Xiaomi Pet Feeder IV2001 Driver
...
local measureControl = capabilities["concertmirror08464.xiaomiFeederIv2001Measure"]
local foodOutControl = capabilities["concertmirror08464.xiaomiFeederIv2001FoodOut"]
local operatingStatus = capabilities["concertmirror08464.xiaomiFeederIv2001Status"]
local foodLeftStatus = capabilities["concertmirror08464.xiaomiFeederIv2001FoodLeft"]
local foodStuckStatus = capabilities["concertmirror08464.xiaomiFeederIv2001FoodStuck"]
local desiccantStatus = capabilities["concertmirror08464.xiaomiFeederIv2001Desiccant"]
local childLockControl = capabilities["concertmirror08464.xiaomiFeederIv2001ChildLock"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local EXPECTED_PROFILE_NAME = "xiaomi-pet-feeder-iv2001"

-- MIoT model: xiaomi.feeder.iv2001
...
local driver = Driver("miot-xiaomi-pet-feeder-iv2001", {
