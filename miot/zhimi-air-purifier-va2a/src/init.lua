...
-- Exact local MIoT model: Zhimi Air Purifier VA2A
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> zhimiAirVa2aMode.airPurifierMode
--   siid=2 piid=5 -> zhimiAirVa2aFanLevel.fanLevel
--   siid=2 piid=6 -> zhimiAirVa2aAnion.anion
--   siid=3 piid=1 -> humidity
--   siid=3 piid=7 -> temperature
--   siid=3 piid=4 -> pm25
--   siid=4 piid=1 -> filter
--   siid=6 piid=1 -> zhimiAirVa2aBuzzer.buzzer
--   siid=8 piid=1 -> zhimiAirVa2aChildLock.childLock
--   siid=13 piid=2 -> zhimiAirVa2aDisplayLevel.displayLevel
