-- Xiaomi Smart Standing Fan 2 P30 Driver
...
local fanModeCap = capabilities["concertmirror08464.dmakerFanP30FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.dmakerFanP30IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.dmakerFanP30Buzzer"]
local childLockCap = capabilities["concertmirror08464.dmakerFanP30ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.dmakerFanP30HorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "dmaker-fan-p30"

-- MIoT model: dmaker.fan.p30
-- Source: exact MIoT spec urn:miot-spec-v2:device:fan:0000A005:dmaker-p30:1
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local SWING_ANGLE_PIID = 5        -- 30, 60, 90, 120, 140; not exposed
local POWER_OFF_TIME_PIID = 6     -- countdown minutes; not exposed
...
local driver = Driver("miot-dmaker-fan-p30", {
