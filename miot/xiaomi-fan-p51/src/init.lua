...
local fanModeCap = capabilities["concertmirror08464.xiaomiFanP51FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.xiaomiFanP51IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.xiaomiFanP51Buzzer"]
local childLockCap = capabilities["concertmirror08464.xiaomiFanP51ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.xiaomiFanP51HorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "xiaomi-fan-p51"

-- MIoT model: xiaomi.fan.p51
-- Source: exact MIoT spec urn:miot-spec-v2:device:fan:0000A005:xiaomi-p51:1.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local SWING_ANGLE_PIID = 5        -- 30, 60, 90, 120
...
local driver = Driver("miot-xiaomi-fan-p51", {
