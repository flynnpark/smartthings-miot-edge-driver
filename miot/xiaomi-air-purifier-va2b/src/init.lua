...
-- Exact local MIoT model: Xiaomi Air Purifier VA2B
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> xiaomiAirVa2bMode.airPurifierMode
--   siid=2 piid=5 -> xiaomiAirVa2bFanLevel.fanLevel
--   siid=2 piid=6 -> xiaomiAirVa2bAnion.anion
--   siid=3 piid=1 -> humidity
--   siid=3 piid=2 -> temperature
--   siid=3 piid=4 -> pm25
--   siid=4 piid=1 -> filter
--   siid=6 piid=1 -> xiaomiAirVa2bBuzzer.buzzer
--   siid=8 piid=1 -> xiaomiAirVa2bChildLock.childLock
--   siid=13 piid=1 -> xiaomiAirVa2bDisplayLevel.displayLevel
