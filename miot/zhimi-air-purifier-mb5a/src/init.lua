-- Zhimi Air Purifier MB5A Driver
...
local fanModeFanMode = capabilities["concertmirror08464.zhimiAirMb5aFanMode"]
local fanSpeedFanSpeed = capabilities["concertmirror08464.zhimiAirMb5aFanSpeed"]
local deviceControlsBuzzer = capabilities["concertmirror08464.zhimiAirMb5aBuzzer"]
local deviceControlsChildLock = capabilities["concertmirror08464.zhimiAirMb5aChildLock"]
local deviceControlsLedBrightness = capabilities["concertmirror08464.zhimiAirMb5aLedBrightness"]
...
local function ensure_profile(device)
    if not device:supports_capability_by_id(fanModeFanMode.ID, "main") then
        device:try_update_metadata({profile = "zhimi-mb5a"})
    end
end
...
local driver = Driver("miot-air-purifier-mb5a", {
