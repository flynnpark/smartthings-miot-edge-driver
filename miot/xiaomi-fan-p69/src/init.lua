...
local SUPPORTED_HORIZONTAL_ANGLES = {30, 60, 90, 120}
local SUPPORTED_VERTICAL_ANGLES = {30, 60, 90, 100}
...
local function emit_supported_angles(device)
    ...
    device:emit_event(verticalAngleCap.supportedVerticalAngles({value = SUPPORTED_VERTICAL_ANGLES}))
end
