...
local controls = capabilities["concertmirror08464.xiaomiDehumidifierLiteControls"]
local status = capabilities["concertmirror08464.xiaomiDehumidifierLiteStatus"]
