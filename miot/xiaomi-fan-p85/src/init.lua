-- Mijia Smart Standing Fan Pro Slim Driver
...
local fanModeCap = capabilities["concertmirror08464.xiaomiFanP85FanMode"]
local indicatorLightCap = capabilities["concertmirror08464.xiaomiFanP85IndicatorLight"]
local buzzerCap = capabilities["concertmirror08464.xiaomiFanP85Buzzer"]
local childLockCap = capabilities["concertmirror08464.xiaomiFanP85ChildLock"]
local horizontalAngleCap = capabilities["concertmirror08464.xiaomiFanP85HorizontalAngleV2"]

local fanSpeedPercent = capabilities["fanSpeedPercent"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "xiaomi-fan-p85"

-- MIoT model: xiaomi.fan.p85
-- Source: exact MIoT spec urn:miot-spec-v2:device:fan:0000A005:xiaomi-p85:1:0000D062.
-- Fan service (siid=2)
local FAN_SIID = 2
local POWER_PIID = 1
...
local SWING_ANGLE_PIID = 7        -- 30, 60, 90
...
local driver = Driver("miot-xiaomi-fan-p85", {
