...
| Wind mode | RW | `siid=2`, `piid=5`; `0=normal`, `1=nature` | `zhimiFanZa4FanMode.fanMode` |
| Display brightness | RW | `siid=5`, `piid=1`; `0=normal`, `1=dim`, `2=off` | `zhimiFanZa4DisplayBrightness.displayBrightness` |
| Buzzer | RW | `siid=4`, `piid=1` | `zhimiFanZa4Buzzer.buzzer` |
| Child lock | RW | `siid=3`, `piid=1` | `zhimiFanZa4ChildLock.childLock` |

Angle control: `zhimiFanZa4HorizontalAngleV2.horizontalAngle` maps MIoT `siid=2`, `piid=4`, `0..120`.
