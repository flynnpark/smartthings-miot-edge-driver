...
local fanLevelCap = capabilities["concertmirror08464.zhimiFanFb1FanLevel"]
local fanModeCap = capabilities["concertmirror08464.zhimiFanFb1FanMode"]
local hAngleCap = capabilities["concertmirror08464.zhimiFanFb1HorizontalAngleV2"]
local vAngleCap = capabilities["concertmirror08464.zhimiFanFb1VerticalAngleV2"]
local indicatorCap = capabilities["concertmirror08464.zhimiFanFb1Indicator"]
local buzzerCap = capabilities["concertmirror08464.zhimiFanFb1Buzzer"]
local childLockCap = capabilities["concertmirror08464.zhimiFanFb1ChildLock"]

local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60
local PROFILE_NAME = "zhimi-fan-fb1"

-- MIoT model: zhimi.fan.fb1
-- specModel: zhimi-fb1
...
local SWING_PIID = 3
local H_ANGLE_PIID = 5
local V_ANGLE_PIID = 6
local MODE_PIID = 7
...
local function device_added(_, device)
    ...
    device:emit_event(vAngleCap.verticalAngle({value = "45"}))
...
local driver = Driver("miot-zhimi-fan-fb1", {
