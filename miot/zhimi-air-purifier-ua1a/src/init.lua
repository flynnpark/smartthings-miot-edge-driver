...
-- Exact local MIoT model: Zhimi Air Purifier UA1A
-- Property mappings below come from the exact MIoT specification.
--
--   siid=2 piid=1 -> power
--   siid=2 piid=4 -> zhimiAirUa1aMode.airPurifierMode
--   siid=2 piid=5 -> zhimiAirUa1aFanLevel.fanLevel
--   siid=2 piid=7 -> zhimiAirUa1aUv.uv
--   siid=2 piid=6 -> zhimiAirUa1aPlasma.plasma
...
--   siid=6 piid=1 -> zhimiAirUa1aBuzzer.buzzer
--   siid=8 piid=1 -> zhimiAirUa1aChildLock.childLock
--   siid=9 piid=12 -> zhimiUa1aDisplayBrightness.displayBrightnessLevel
--   siid=13 piid=1 -> zhimiAirUa1aDisplay.display
