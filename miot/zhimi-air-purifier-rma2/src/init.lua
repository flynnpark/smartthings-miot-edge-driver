-- Zhimi Air Purifier RMA2 Driver
...
local PROFILE_NAME = "zhimi-rma2"
local POLLING_TIMER = "polling_timer"
local DEFAULT_POLLING_INTERVAL = 60

-- MIoT spec: urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-rma2:1
...
local driver = Driver("miot-air-purifier-rma2", {
